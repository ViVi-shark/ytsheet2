...
<head>
  ...
  <link rel="stylesheet" media="all" href="${main::core_dir}/skin/_common/css/text_menu.css?${main::ver}">
...
print <<"HTML";
          <tbody>
            ...
            <tr class="source">
              <td colspan="10">
                @{[input "vehicle${num}SourceName",'','','placeholder="出典" list="source-names"']}
                @{[input "vehicle${num}SourcePage",'number','','placeholder="ページ"']}
              </td>
            </tr>
          </tbody>
HTML
...
@{[ &commonJSVariable ]}
  ...
  <script src="${main::core_dir}/skin/_common/js/text_menu.js"></script>
</body>
