      ...
      <div class="box" id="name-form">
        <div>
          <dl id="character-name">
            <dt>名称
            <dd>@{[ input('monsterName','text',"nameSet") ]}<span data-related-field="monsterName"></span>
          </dl>
          <dl id="aka">
            <dt>名前
...
print <<"HTML";
      ...
      <fieldset class="box loots monster-only">
        <h2>戦利品@{[ checkbox 'disableLoots','戦利品をもたない','switchLoots' ]}</h2>
        <div id="loots-list">
          <ul id="loots-num">
HTML
