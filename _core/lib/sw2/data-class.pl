...
our %class = (
  ...
  'エンハンサー' => {
    ...
    craft => {
      ...
      eName => 'enhance',
      data => [
        [1,'アンチボディ','[補][準]',{ duration => '30秒', }],
        [1,'オウルビジョン','[補]',{ duration => '3分', }],
        [1,'ガゼルフット','[補][準]',{ duration => '30秒', }],
        [1,'キャッツアイ','[補]',{ duration => '30秒', }],
        [1,'スケイルレギンス','[補]',{ duration => '1時間', }],
        [1,'ストロングブラッド','[補][準]',{ duration => '30秒', }],
        [1,'チックチック','[補]',{ duration => '1時間', }],
        [1,'ドラゴンテイル','[補]',{ duration => '3分', }],
        [1,'ビートルスキン','[補][準]',{ duration => '30秒', }],
        [1,'マッスルベアー','[補]',{ duration => '30秒', }],
        [1,'メディテーション','[補][準]',{ duration => '30秒', }],
        [1,'ラビットイヤー','[補]',{ duration => '3分', }],
        [5,'ケンタウロスレッグ','[補][準]',{ duration => '10秒', }],
        [5,'シェイプアニマル','[補]',{ duration => '1時間', }],
        [5,'ジャイアントアーム','[補]',{ duration => '10秒', }],
        [5,'スフィンクスノレッジ','[補][準]',{ duration => '10秒', }],
        [5,'デーモンフィンガー','[補]',{ duration => '10秒', }],
        [5,'ファイアブレス','[補]',{ duration => '30秒', }],
        [5,'リカバリィ','[補]',{ duration => '一瞬', }],
        [5,'ワイドウィング','[補]',{ duration => '3分', }],
        [10,'カメレオンカムフラージュ','[補][準]',{ duration => '30秒', }],
        [10,'クラーケンスタビリティ','[補][準]',{ duration => '30秒', }],
        [10,'ジィプロフェシー','[補][準]',{ duration => '1時間', }],
        [10,'ストライダーウォーク','[補]',{ duration => '3分', }],
        [10,'スパイダーウェブ','[補]',{ duration => '3分', }],
        [10,'タイタンフット','[補]',{ duration => '10秒', }],
        [10,'トロールバイタル','[補][準]',{ duration => '30秒', }],
        [10,'バルーンシードショット','[補]',{ duration => '30秒', }],
        [10,'フェンリルバイト','[補]',{ duration => '3分', }],
        [10,'ヘルシーボディ','[補]',{ duration => '一瞬', }],
        [16,'アナライズブレイン','2.0[補]',{ duration => '30秒', cost => 10, }],
        [16,'ウェンディゴハイド','2.0[補]',{ duration => '30秒', cost => 10, no_grouping => 1, }],
        [16,'ヴジャトーアイ','2.0[補]',{ duration => '30秒', cost => 10, no_grouping => 1, }],
      ],
    },
  },
  'バード' => {
  ...
  'ウォーリーダー' => {
    ...
    craft => {
      ...
      data => [
        ...
        [ 1,'鉄壁の防陣Ⅰ','[補]',{'陣気' => 1}],
        [ 1,'鉄壁の防陣Ⅱ：鉄鎧','[補]',{'陣気' => 1}],
        [ 1,'鉄壁の防陣Ⅱ：堅体','[補]',{'陣気' => 1, options => ['物理ダメージ', '魔法ダメージ']}],
        [ 5,'鉄壁の防陣Ⅲ：鋼鎧','[補]',{'陣気' => 1}],
        [ 5,'鉄壁の防陣Ⅲ：甲盾','[補]',{'陣気' => 1}],
        [ 5,'鉄壁の防陣Ⅳ：城鎧','[補]',{'陣気' => 2}],
        [ 5,'鉄壁の防陣Ⅳ：鏡盾','[補]',{'陣気' => 2}],
        [10,'鉄壁の防陣Ⅴ：鋼城','[補]',{'陣気' => 0}],
        [10,'鉄壁の防陣Ⅴ：巨壁','[補]',{'陣気' => 0}],
        [ 1,'強靭なる丈陣Ⅰ','[補]',{'陣気' => 1, options => ['生命抵抗力判定', '精神抵抗力判定']}],
        [ 1,'強靭なる丈陣Ⅱ','[補]',{'陣気' => 1, options => ['生命抵抗力判定', '精神抵抗力判定']}],
        [ 5,'強靭なる丈陣Ⅲ','[補]',{'陣気' => 1, options => ['生命抵抗力判定', '精神抵抗力判定']}],
        [ 5,'強靭なる丈陣Ⅳ','[補]',{'陣気' => 2, options => ['生命抵抗力判定', '精神抵抗力判定']}],
        [10,'強靭なる丈陣Ⅴ：激生','[補]',{'陣気' => 0}],
        [10,'強靭なる丈陣Ⅴ：魔泉','[補]',{'陣気' => 0}],
...
sub getAlchemistCraft {
  my $targetName = shift;
  my %craft = %{getCraft('アルケミスト', $targetName);};

  if ($craft{version} =~ s#\[([赤緑黒白金\d]+)]##) {
    $craft{cost} = $1;
  }
...
sub getDarkHunterCraft {
  my $targetName = shift;
  return getCraft('ダークハンター', $targetName);
}
